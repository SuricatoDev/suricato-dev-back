...
<body>
    <div class="container">
        ...
        <div class="content" style="padding: 16px;">
            ...
            <p style="color: #6A6A6A;">Confirme seu e-mail para ter acesso a todas as funcionalidades do site.</p>

            <div class="code">
                <a href="{{ $link }}">Confirmar e-mail</a>
            </div>

            <p style="color: #6A6A6A;">Se você não se cadastrou no site, por favor, ignore este e-mail.</p>
            <br>
